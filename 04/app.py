...
def handle_message(event):
    ...
    if getA =='0' :
        photopath='https://0c7c-210-240-156-93.ngrok-free.app'        
        imageURL = random.choice([photopath+'/static/a.jpg', photopath+'/static/b.jpg', photopath+'/static/c.png', photopath+'/static/d.jpg'])
